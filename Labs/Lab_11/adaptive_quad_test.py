...
print("the adaptive quadrature's error is around 10^-6")
print("adaptivecomposite trap's error is around 10^-3")
print("adaptive simpson's error is around 10^-1")
print("in all cases the adaptive code outperformed the non-adaptive code")
print("This leads me to the conclusion that adaptive quadrature performs the best by a large margin!")
